      ...
      <section className='form_section'>
        <form onSubmit={handleSubmit} className="form">
          {confirmation === false ? <>
            ...
            <p>Our monthly subscription price is now only <span className='highlight'>50 BDT</span>. Subscription details <span className='highlight'>50BDT 1 Month</span></p>
            ...
            <input value="50 (BDT)" name="payableamount" onChange={(e) => onChangeHandler(e)} placeholder="Payable Amount" className="form_input" disabled />
